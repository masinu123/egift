    ...
    */
    Pages.prototype.initSidebar = function(context) {
        ...
        $('[data-pages="sidebar"]', context).each(function() {
            ...
            var isShowSideBarMenu = localStorage.getItem('menuSpin');
            if(isShowSideBarMenu === 'true'){
 ...
 (function($) {
    ...
    var Sidebar = function(element, options) {
     ...
     Sidebar.prototype.togglePinSidebar = function(toggle) {
         ...
         localStorage.setItem(this.menuCookieName, this.$body.hasClass('menu-pin'));
     }
